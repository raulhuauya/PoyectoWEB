...
<p class="style1">SELECCIONE LA IMAGEN A USAR PARA<BR />
  CLIENTE***************</p>
<form action="/cosisered/img/cc0001/cls_up_nw.php" method="post" enctype="multipart/form-data"> 
	...
	while ($elemento = $dir->read())
	{
		...
		if ($left_==true)
		{
			if (strrpos($elemento, ".jp")>0)
			{
			   ...
			   echo "<tr><td><table width='90%' border='0' cellspacing='0' cellpadding='0'><tr><td align='center'><img src='../img/cc0001/".$elemento."' width='200px' />"."</td></tr><tr><td align='center'>".$elemento."</td></tr></table></td>";
		...
		else
		{
			if (strrpos($elemento, ".jp")>0)
			{
			   echo "<td><table width='90%' border='0' cellspacing='0' cellpadding='0'><tr><td align='center'><img src='../img/cc0001/".$elemento."' width='200px' />"."</td></tr><tr><td align='center'>".$elemento."</td></tr></table></td></tr>";
			   $aux_name_new_img=str_replace(".jpeg", "",$elemento) + 0;
			   if ($aux_name_new_img>$aux_index)
			   {$aux_index=($aux_name_new_img + 0);}
			 }
