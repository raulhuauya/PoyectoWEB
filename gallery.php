	...
	function show($area = 500, $width = 100, $space = 10){
		...
		echo '<div name="xx" style="width:'.$area.'px">';
			...
			for($i = 0; $i < $total; $i++){		
				...
				echo '<div style="width:'.$width.'px; float:left; padding-right:'.$space.'px; padding-bottom:'.$space.'px;"><a href="'.$this->path.'/'.$this->files[$i].'" rel="lightbox"><img src="'.$this->path.'/'.$this->files[$i].'" width="'.$width.'"  border="0"></img></a></div>';
