...
<table width="760px" height="760px" align="center" bgcolor="#ffffff" cellpadding="0" cellspacing="0" >
  <tr>
	...
	<td width="740" height="40"class="encabezado-proyectos" bgcolor="#2c6eb5">&nbsp;</td>
	<td width="10" height="40" bgcolor="#2c6eb5"></td>
	</tr>
  	<tr>
		...
		<table width="740" height="680" cellpadding="0" cellspacing="0" style="top:auto">
					...
					if ($totproy> 0) {
						...
						echo // <a name='".$_GET['id']."'></a>
							" 
								...
								<tr>
											<td height='20'  >&nbsp;</td>
											<td height='20'  class='titulo-proyectos' ><a>".$rowproy['TITLE']."</a></td>
											<td height='20'  >&nbsp;</td>
								</tr>
								<tr>
											<td>&nbsp;</td>
						...
						echo // <a name='".$_GET['id']."'></a>
							" 
								...
								<tr>
											<td height='20' >&nbsp;</td>
											<td height='20'  class='titulo-proyectos' ><a>".$rowproy['TITLE_EN']."</a></td>
											<td height='20'  >&nbsp;</td>
								</tr>
								<tr>
											<td>&nbsp;</td>
  	...
  	<tr>
    	<td width="10" height="40" bgcolor="#2c6eb5">&nbsp;</td>
    	<td width="740" height="40" class="volver"><a href="portada.php"><?php echo $volver; ?>&nbsp;&nbsp;&nbsp;&nbsp;</a>
		</td>
    	<td width="10" height="40" bgcolor="#2c6eb5">&nbsp;</td>
  	</tr>
	</table>
